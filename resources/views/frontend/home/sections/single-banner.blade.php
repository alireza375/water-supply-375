            ...
            <div class="col-xl-6 col-lg-6">
                ...
                <div class="wsus__single_banner_content">
                    <a href="{{$homepage_secion_banner_two->banner_one->banner_url}}">
                        <img class="img-gluid" src="{{asset($homepage_secion_banner_two->banner_one->banner_image)}}"
                            alt="">
                    </a>
                </div>
                @endif
            ...
            <div class="col-xl-6 col-lg-6">
                ...
                <div class="wsus__single_banner_content">
                    <a href="{{$homepage_secion_banner_two->banner_two->banner_url}}">
                        <img class="img-gluid" src="{{asset($homepage_secion_banner_two->banner_two->banner_image)}}"
                            alt="">
                    </a>
                </div>
                @endif
